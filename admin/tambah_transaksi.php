        ...
        <div class="card-body">
            ...
            <form action="transaksi_aksi.php" method="post">
                <div class="form-group">
                    ...
                    <select class="form-control" name="pelanggan" required>
                        ...
                        foreach ($hasil as $item){ ?>
                            <option value="<?php echo $item['pelanggan_id'];?>">
                               KP - <?php echo $item['pelanggan_id'];?> ||
                                <?php echo $item['pelanggan_nama'];?>
                                </option>
                            <?php } ?>
                    </select>
                </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <td> <select class="form-control" name="jenis_pakaian[]" required>
                        <option value="">- Pilih Pakaian</option>
                         <?php
                        $query =  mysqli_query($koneksi, "select * from pakaian");
                        $hasil = mysqli_fetch_all($query, MYSQLI_ASSOC);
                        foreach ($hasil as $list){ ?>
                            <option value="<?php echo $list['pakaian_jenis'];?>">
                                 <?php echo $list['pakaian_jenis'];?>
                                </option>
                            <?php } ?>
                        </select>
                        </td>
