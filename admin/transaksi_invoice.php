        ...
        <div class="card">
            <div class="card-body">
                ...
                foreach ($result as $item){ ?>
                    <center><h2> <b>SRI KARYA </b>LAUNDRY</h2></center>
                    <br>
                    <div class="dropdown-divider"></div>
                    
                    <br>
                    <a href="setting/transaksi_invoice_cetak.php?id=<?php echo $item['transaksi_id'];?>" target="_blank" class="btn btn-primary float-lg-right">Cetak Data</a>
                    <br>
                    <br>
                    <table class="table">
                        <tr>
