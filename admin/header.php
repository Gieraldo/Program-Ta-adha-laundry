...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a class="navbar-brand" href="index.php">Sri Karya Laundry</a>
    ...
    <div class="nav navbar-nav collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="pakaiansatuan.php"><i class="fas fa-tshirt mr-1"></i>Pakaian</a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="transaksi.php"><i class="fas fa-comment-dollar mr-1"></i>Cucian Dan Transaksi</a>
            </li>
            <li class="nav-item active">
